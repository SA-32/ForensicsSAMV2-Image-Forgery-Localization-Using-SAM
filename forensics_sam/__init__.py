...
class ForensicsSAM(nn.Module):
    def __init__(self, sam_model, r=8, lora_layer=None):
        ...
        self.sam = sam_model
        self.load_all_parameters(f"./weight/forgery_experts.pth")
        ...
        self.load_all_parameters(f"./weight/adversary_experts.pth")
    ...
    def forward(self, images, activate_adv):
        ...
        gated_mask, mask_prediction, iou_prediction, auth_logit = self.sam.mask_decoder(
        ...
        return mask_prediction, cls_prediction, gated_mask, auth_logit, iou_prediction
